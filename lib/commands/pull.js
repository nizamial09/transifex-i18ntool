...
module.exports = async function(args) {
  ...
  // TODO resource must be part of config! demnach auch in help und readme
  ...
  if (typeof args.p === 'undefined') {
    let project = await prompts(projectPrompt);
  ...
  if (typeof args.l === 'undefined') {
    let languagesPrompt = await prompts(languagePrompt);
