...
module.exports = async function(args) {
  ...
  if (typeof args.o === 'undefined' || typeof args.p === 'undefined') {
    process.stdout.write('No Organization or project slug defined.'.red + '\n');
    process.stdout.write('Please set options ' + '-o'.cyan + ' and ' + '-p\n'.cyan);
    return;
  }
    ...
    if (!Array.isArray(body) && typeof body.error_code !== 'undefined') {
      switch (body.error_code) {
        case 'authentication_failed':
          process.stdout.write('Authentication failed, the token is invalid.\n'.red);
          break;
        case 'not_found':
